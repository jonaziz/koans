...
class AboutMessagePassing < EdgeCase::Koan
  ...
  def test_calling_method_missing_causes_the_no_method_error
    ...
    ## Whatever you redefine it to cause? Within current scope.
  ...
  def test_all_messages_are_caught
    ...
    # What is this? Some way of rescuing no method errors?
  ...
  def test_catching_messages_makes_respond_to_lie
    ...
    # This doesn't make these methods exist, just prevents errors [?]
  end
  ...
  def test_explicitly_implementing_respond_to_lets_objects_tell_the_truth
    ...
    # Isn't that a really questionable thing to do?
