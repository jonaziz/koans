...
class AboutClassMethods < EdgeCase::Koan
  ...
  ## I prefer class << self in theory because it keeps the self methods away
  ## from insitance methods, assuming your class will have a mix of self and
  ## instance methods. If 100% self, I would use Self#Method.
